...
public class Zombie extends  Creature{
    ...
    public void init(){
        animationDown= new Animation(200,Assets.zombie_down);
        animationUp= new Animation(200,Assets.zombie_up);
        animationRight= new Animation(200,Assets.zombie_right);
        animationLeft= new Animation(200,Assets.zombie_left);
    }
